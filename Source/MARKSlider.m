...
- (void)setUpViewComponents
{
    ...
    self.leftThumbImageView = [[UIImageView alloc] initWithImage:nil];
    self.leftThumbImageView.userInteractionEnabled = NO;
...
- (CGSize)intrinsicContentSize {
    CGFloat width = _trackImage.size.width + _rightThumbImage.size.width + _rightThumbImage.size.width;
    CGFloat height = _rightThumbImage.size.height;
...
- (void)layoutSubviews
{
    ...
    CGFloat leftAvailableWidth = width - rightThumbImageSize.width;
    ...
    CGFloat leftInset = leftThumbImageSize.width / 3;
    CGFloat rightInset = rightThumbImageSize.width / 1.7;
